...
The [IBM2 Mac Beta](https://github.com/IBM/it-architecture-diagrams/releases) of the diagrams.net desktop is currently available.  Windows desktop with IBM2 will be avaiaible when IBM2 is published.  Note that the drawIT beta will change until finalized, and the IBM2 beta will change when IBM2 is published.  
